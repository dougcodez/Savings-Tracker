...
public class SavingsTrackerDatabaseInit extends HikariSetup {
    ...
    private void initTables() {
        createTable("CREATE TABLE IF NOT EXISTS SAVINGS(ID INTEGER(10) NOT NULL AUTO_INCREMENT, NAME VARCHAR(255), DATE VARCHAR(255), DESCRIPTION VARCHAR(255), AMOUNT INTEGER(10) NOT NULL, " +
                "PRIMARY KEY (ID))");
    }
